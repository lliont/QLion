...
*
* Modified for QLion Card serial hardware
* 
...
ESP_W     EQU       2
        ...
        include dev8_esp_mt_inc
        include dev8_esp_err_inc
        include dev8_esp_vect_inc
...
open:
        ...
        and.l   2(a0),d0
        cmpi.l  #'SER3',d0      ; check against 'SER4'
        beq.s   open2
        cmpi.l  #'ESP1',d0      ; and against 'SRX4'
...
pend    tst.b   pend_flg(a3)    ; is there input pending?
        ...
        btst.b  #ESP_DR,ESP_STAT     ; is RX fifo empty?
        beq.s   pendrts         ; yes, return NC
...
send    btst.b  #ESP_RD,ESP_STAT      ; is there room in the fifo
